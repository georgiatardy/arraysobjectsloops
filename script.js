...
/*
6. Now that you've added a "boxoffice" property, subtract "boxoffice" from "budget" and return the difference. This number is the amount lost by the studio in making the film. Return the loss.
*/
function getLosses(){
    film.boxoffice - film.budget;
